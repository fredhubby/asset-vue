      ...
      <el-form-item>
        <el-row class="el-row4">
          ...
          <el-col :span="7"><div class="grid-content3" style="text-align: start">
            <el-select v-model="form.value5" clearable filterable placeholder="请选择">
              <el-option
          ...
          <el-col :span="7"><div class="grid-content2"><el-input v-model="form.value6"></el-input></div></el-col>
        </el-row>
      </el-form-item>
