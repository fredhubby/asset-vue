          ...
          <el-popover
            ...
            <el-form ref="form1" :model="form1">
              <el-row :gutter="20" type="flex" class="row-bg">
                ...
                <el-form-item>
                  <el-col :span="2"><el-checkbox v-model="form1.zqbj_checked">债权本金</el-checkbox></el-col>
                </el-form-item>
                <el-form-item>
                  <el-col :span="30"><el-input v-model="form1.zqbj" clearable :disabled="Boolean(!form1.zqbj_checked)"></el-input></el-col>
                </el-form-item>
              </el-row>
              <el-row :gutter="20" type="flex" class="row-bg">

                <el-form-item>
                  <el-col :span="2"><el-checkbox v-model="form1.qdcb_checked">取得成本</el-checkbox></el-col>
                </el-form-item>
                <el-form-item>
                  <el-col :span="30"><el-input v-model="form1.qdcb" clearable :disabled="Boolean(!form1.qdcb_checked)"></el-input></el-col>
                </el-form-item>
                <el-form-item>
                  <el-col :span="2"><el-checkbox v-model="form1.pgjg_checked">评估价格</el-checkbox></el-col>
                </el-form-item>
                <el-form-item>
                  <el-col :span="30"><el-input v-model="form1.pgjg" clearable :disabled="Boolean(!form1.pgjg_checked)"></el-input></el-col>
                </el-form-item>
                <el-form-item>
    ...
    <el-card class="box-card">
      ...
      <div  class="text item">
        <el-table :data="tableData" border height="500" style="width: 100%" class="el-table"
          ...
          <el-table-column prop="zqr" label="债权人" width="150"></el-table-column>
