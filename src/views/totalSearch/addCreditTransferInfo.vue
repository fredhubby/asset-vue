  ...
  <div>
    ...
    <el-form ref="form1" :model="form1">
      ...
      <el-form-item label="借据1：" style="margin-top: 20px">
        <el-input v-model="form1.value9" style="width: 40%;"></el-input><i class="el-icon-remove"></i>
      </el-form-item>
        <el-form-item label="借据2：">
          <el-input v-model="form1.value10" style="width: 40%"></el-input>
          <i class="el-icon-circle-plus"></i><i class="el-icon-remove"></i>
      </el-form-item>
    </el-form>
  </div>
</template>
