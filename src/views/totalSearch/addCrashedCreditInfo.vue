  ...
  <el-form ref="form1" :model="form1">
    <el-form-item>
      <el-row class="el-row2">
        ...
        <el-col :span="2"><div class="grid-content1" style="margin-left: 20px">破产受理日：</div></el-col>
    ...
    <el-form-item>
      <el-row class="el-row3">
        ...
        <el-col :span="2"><div class="grid-content1" style="margin-left: 20px">债权申报人：</div></el-col>
    ...
    <el-form-item>
      <el-row class="el-row4">
        ...
        <el-col :span="2"><div class="grid-content1" style="margin-left: 20px">申报金额：</div></el-col>
    ...
    <el-form-item>
      <el-row class="el-row5">
        ...
        <el-col :span="2"><div class="grid-content1" style="margin-left: 20px">认定金额：</div></el-col>
    ...
    <el-form-item>
      <el-row class="el-row6">
        ...
        <el-col :span="2"><div class="grid-content1" style="margin-left: 20px">联系人及电话：</div></el-col>
    ...
    <el-form-item>
      <el-row class="el-row7">
        ...
        <el-col :span="7"><div class="grid-content2"><el-input v-model="form1.value10"></el-input></div></el-col>
      </el-row>
    </el-form-item>
  </el-form>
  </div>
